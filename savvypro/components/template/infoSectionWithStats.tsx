          ...
          <div className=" text-gray-700">
            <Container className="py-0">
              ...
              <div className="flex flex-col lg:flex-row lg:-mx-4">
                ...
                <div className="lg:w-1/2 lg:px-4 order-1 lg:order-none mb-12 lg:mb-0" style={{paddingTop: '68px'}}>
                  <Player
                    playsInline
            ...
            <div className=" background-gradient-dark relative py-16 mt-60 lg:mt-40">
              <Image
                {...bannerImage}
