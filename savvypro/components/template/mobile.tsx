...
} from "./infoSectionWithStatsMobile";

import { TemplateClassesTabDataMobile, TemplateClassesTabMobile } from "./classesTabMobile";
...
export class TemplateRenderMobile extends Component<TemplateRenderProps> {
  getTemplate(
    props: Templates,
    sectionTitle: {
      subTitle?: string;
    ...
    switch (props.type) {
      ...
      case "TemplateClassesTab":
        return <TemplateClassesTabMobile {...props.data} heading={sectionTitle} />;
  ...
  render() {
    ...
    return (
      <div style={{ margin: 0, overflowX: 'hidde' }}>
